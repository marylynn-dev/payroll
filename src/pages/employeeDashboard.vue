...
import { useEmployeeDashboard } from "@/stores/employeeDashboard";
...
onMounted(async () => {
  localStorage.setItem(
    "token",
    "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpYXQiOjE3NjE3NDQyMjYsImV4cCI6MTc2MTc0NzgyNiwiYXVkIjoidW5kZWZpbmVkIiwiaXNzIjoibWUuY29tIn0.G6QRvS-YRR2cayji-nAYqbPet0tAngOn5opjulVmUJI"
  );
